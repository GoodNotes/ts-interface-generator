...
export interface WidgetTime {
    ...
    readonly "liveSpan"?: "1m" | "5m" | "10m" | "15m" | "30m" | "1h" | "4h" | "1d" | "2d" | "1w" | "1mo" | "3mo" | "6mo" | "week_to_date" | "month_to_date" | "1y" | "alert" | UnparsedObject;
}
...
export interface WidgetConditionalFormat {
    ...
    readonly "palette": "blue" | "custom_bg" | "custom_image" | "custom_text" | "gray_on_white" | "grey" | "green" | "orange" | "red" | "red_on_white" | "white_on_gray" | "white_on_green" | "green_on_white" | "white_on_red" | "white_on_yellow" | "yellow_on_white" | "black_on_light_yellow" | "black_on_light_green" | "black_on_light_red" | UnparsedObject;
...
export interface FormulaAndFunctionEventQueryDefinition {
    ...
    readonly "dataSource": "logs" | "spans" | "network" | "rum" | "security_signals" | "profiles" | "audit" | "events" | "ci_tests" | "ci_pipelines" | UnparsedObject;
    /** Group by options. */
...
export interface FormulaAndFunctionEventQueryDefinitionCompute {
    ...
    readonly "aggregation": "count" | "cardinality" | "median" | "pc75" | "pc90" | "pc95" | "pc98" | "pc99" | "sum" | "min" | "max" | "avg" | UnparsedObject;
...
export interface FormulaAndFunctionApmDependencyStatsQueryDefinition {
    ...
    /** APM statistic. */
    readonly "stat": "avg_duration" | "avg_root_duration" | "avg_spans_per_trace" | "error_rate" | "pct_exec_time" | "pct_of_traces" | "total_traces_count" | UnparsedObject;
}
...
export interface FormulaAndFunctionApmResourceStatsQueryDefinition {
    ...
    readonly "stat": "errors" | "error_rate" | "hits" | "latency_avg" | "latency_distribution" | "latency_max" | "latency_p50" | "latency_p75" | "latency_p90" | "latency_p95" | "latency_p99" | UnparsedObject;
}
...
export interface FormulaAndFunctionSLOQueryDefinition {
    ...
    readonly "measure": "good_events" | "bad_events" | "slo_status" | "error_budget_remaining" | "burn_rate" | "error_budget_burndown" | UnparsedObject;
    /** Name of the query for use in formulas. */
    readonly "name"?: string;
...
export interface DistributionWidgetRequest {
    ...
    readonly "query"?: FormulaAndFunctionMetricQueryDefinition | FormulaAndFunctionEventQueryDefinition | FormulaAndFunctionApmResourceStatsQueryDefinition | UnparsedObject;
...
export interface ListStreamComputeItems {
    /** Aggregation value. */
    readonly "aggregation": "count" | "cardinality" | "median" | "pc75" | "pc90" | "pc95" | "pc98" | "pc99" | "sum" | "min" | "max" | "avg" | "earliest" | "latest" | "most_frequent" | UnparsedObject;
    /** Facet name. */
    readonly "facet"?: string;
}
...
export interface MonitorSummaryWidgetDefinition {
    ...
    /** Widget sorting methods. */
    readonly "sort"?: "name" | "group" | "status" | "tags" | "triggered" | "group,asc" | "group,desc" | "name,asc" | "name,desc" | "status,asc" | "status,desc" | "tags,asc" | "tags,desc" | "triggered,asc" | "triggered,desc" | "priority,asc" | "priority,desc" | UnparsedObject;
